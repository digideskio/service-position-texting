...
if($_GET['event_id'] != '')
{
	positionsAdd($_GET['event_id'], $_GET['title'], $_GET['notify_night'], $_GET['type'], $_GET['leader_id']);
					...
					<form method="get">
						...
						<div class="form-group">
							...
							<select class="form-control" name="type" id="type">
								<option value="0">Leaders only</option>
								<option value="1">Volunteers only</option>
								<option value="2">Leaders or volunteers</option>
							</select>
						</div>
